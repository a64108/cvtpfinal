...
def run():
    ...
    gesture_handler = GestosJogo()

    while True:
        gesture_result = gesture_handler.check_ok_both_hands()
        if gesture_result:
            print("Exiting Option 4")
            break
        print("Option 4 active... Waiting for gestures.")
import cv2
...
def run(cap):
    ...
    while True:
        ...
        # Display "Modo Multiplayer" at the top middle of the frame
        height, width, _ = frame.shape
        text = "Modo Multiplayer"
